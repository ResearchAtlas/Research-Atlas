...
import {
    ...
    MessageSquare, Calculator, GitMerge, Terminal, FlaskConical, FileSearch, BookOpen, X
} from "lucide-react"
...
export function LibrarySidebar({
    ...
    return (
        <>
            ...
            <aside className={cn(
                "border-r border-border flex flex-col overflow-y-auto shrink-0 bg-muted/30 transition-transform duration-300 ease-in-out",
                // Mobile/Tablet styles - Adjusted to top-16 to sit below header
                "fixed top-16 bottom-0 left-0 z-40 w-72 shadow-lg xl:shadow-none",
                isOpen ? "translate-x-0" : "-translate-x-full",
                // Desktop styles (xl+)
                "xl:translate-x-0 xl:static xl:h-full xl:w-72 xl:ml-4 xl:z-auto"
            )}>
                <div className="p-6">
